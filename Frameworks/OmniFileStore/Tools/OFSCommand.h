...
@class OFSCommandArguments;

typedef void (^OFSCommandBlock)(OFSCommandArguments *args);

@interface OFSCommand : NSObject
...
extern void OFSCommandLog(NSString *format, ...) NS_FORMAT_FUNCTION(1,2);
