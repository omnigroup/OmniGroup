...
extern NSString * const OAFlagsChangedEventReceivedNotification; // Posted as flags changed events are generated by -nextEventMatchingMask:untilDate:inMode:dequeue:
